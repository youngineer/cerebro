...
import type { IAlertInfo, ILoginRequest, ISignupRequest } from '../types/interfaces';
...
const AuthPage: FC = (): JSX.Element => {
  ...
  const [signupPayload, setSignupInfo] = useState<ISignupRequest>({
    name: 'Test',
    email: 'test@gmail.com',
    password: 'Test@123',
    confirmPassword: 'Test@123'
  });
  const [loginPayload, setLoginInfo] = useState<ILoginRequest>({
    email: 'test@gmail.com',
    password: 'Test@123'
  });
    ...
    <form onSubmit={handleFormSubmit}>
      <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
        ...
        <label className="input validator">
          ...
          <input name="emailId" type="email" placeholder="suresh.nambiar@gmail.com" required onChange={handleFormDataChange} value={isLogin ? loginPayload.email : signupPayload.email} />
        </label>
